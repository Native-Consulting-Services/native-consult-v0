      ...
      <div className="container py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              <div className="h-8 w-8 rounded bg-primary flex items-center justify-center">
                <span className="text-primary-foreground font-bold text-sm">NCS</span>
              </div>
              <span className="font-bold">Native Consulting Services</span>
            </div>
            <p className="text-sm text-muted-foreground">Your Native Partner in Software Solutions</p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Link href="/case-studies" className="block text-sm text-muted-foreground hover:text-primary">
                Case Studies
              </Link>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm text-muted-foreground">Hosted on OVHcloud</span>
              </div>
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm text-muted-foreground">Data Sovereignty Respected</span>
              </div>
            </div>
          </div>
        ...
        <div className="border-t mt-8 pt-8 text-center">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} Native Consulting Services. All rights reserved. Committed to tribal data
            sovereignty and privacy protection.
          </p>
        </div>
      </div>
    </footer>
